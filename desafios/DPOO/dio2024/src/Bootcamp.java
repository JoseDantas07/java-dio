...
public class Bootcamp {
    ...
    private final OffsetDateTime dataInical = OffsetDateTime.now();
    private final OffsetDateTime dataFinal = dataInical.plusDays(45);
    ...
    public OffsetDateTime getDataInical() {
        return dataInical;
    }
